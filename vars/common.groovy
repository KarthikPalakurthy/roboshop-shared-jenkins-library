...
def artifacts() {
    ...
    sh "aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 515990482874.dkr.ecr.us-east-1.amazonaws.com"
    sh "docker push 515990482874.dkr.ecr.us-east-1.amazonaws.com/${component}:${TAG_NAME}"
